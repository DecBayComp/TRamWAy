...
def _render(args):
	...
	output_basename = kwargs.pop('output', None)
	...
	cell_plot(input_file, output_basename=output_basename, fig_format=fig_format, \
...
def _tesselate(args):
	...
	del kwargs['func']
	del kwargs['reuse']
	tesselate(input_file, avg_cell_count=avg_cell_count, max_level=max_level, \
		**kwargs)
	sys.exit(0)
